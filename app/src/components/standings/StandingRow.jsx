                ...
                <a href={`/Owner/${owner.roster_id}`} className="cellLink">
                    <div className="col-sm-7 text-truncate">
                        <div className="d-flex align-items-center">
                            ...
                            <div className="">
                                <img className="ownerLogo" style={{width:"24px"}} alt="avatar" src={`${avatarBaseURL}${owner?.owner?.avatar? owner.owner.avatar : dummyAvatar}`}/>
                            </div>
                            <div className="mx-1">
                                {  
                                    owner?.owner?.team_name ?
                                        <p className="m-0 mx-1">{owner.owner.team_name} 
                                            <span className="m-0 mx-1" style={{fontSize:"10px", color:"#cbcbcb"}}>{owner.owner.display_name}</span>
                                        </p>
                                    :
                                        <p className="m-0 mx-1">{owner.owner.display_name}</p>
                                }
                                <div className="pb-2 mx-1">
                    ...
                    <div className="col-sm-1">
                        <p className="m-0" style={{fontSize:"12px", color:"white"}}>{owner.settings.fpts}.{owner.settings.fpts_decimal}</p>
                    </div>
                    <div className="col-sm-1">
                        <p className="m-0" style={{fontSize:"12px", color:"white"}}>{owner.settings.ppts}.{owner.settings.ppts_decimal}</p>
                    </div>
                    <div className="col-sm-1">
                        <p className="m-0" style={{fontSize:"12px", color:"white"}}>{owner.settings.fpts_against}.{owner.settings.fpts_against_decimal}</p>
                    </div>
                </a>
            </div>
    )
